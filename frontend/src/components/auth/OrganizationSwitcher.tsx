    ...
    return (
      <div className="relative" ref={menuRef}>
        ...
        {isOpen && showCreateForm && (
          <div className="absolute right-0 mt-2 w-80 rounded-2xl bg-white shadow-lg border border-gray-200 p-4 z-50">
  ...
  return (
    <div className="relative" ref={menuRef}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 min-w-[160px]"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 rounded-2xl bg-white shadow-lg border border-gray-200 py-1 z-50">
          {!showCreateForm ? (
            <>
