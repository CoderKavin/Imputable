  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <h3 className={`font-medium ${highlight ? "text-indigo-900" : "text-gray-900"}`}>
          {title}
        </h3>
        <p className={`text-sm mt-0.5 ${highlight ? "text-indigo-600" : "text-gray-500"}`}>
          {description}
        </p>
      </div>
...
function OnboardingStep({
  ...
  return (
    <div className="flex items-start gap-3">
      ...
      <div>
        <p className={`font-medium ${completed ? "text-emerald-600" : "text-gray-900"}`}>
          {title}
        </p>
    ...
    <div className="flex items-center justify-center min-h-[60vh]">
      <div className="text-center max-w-md">
        ...
        <div className="p-6 bg-amber-50 rounded-2xl border border-amber-100 text-left">
          <h3 className="font-semibold text-amber-900 mb-2">How to get started:</h3>
